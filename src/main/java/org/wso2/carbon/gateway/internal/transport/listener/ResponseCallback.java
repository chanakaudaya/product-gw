...
public class ResponseCallback implements CarbonCallback {
    ...
    public void done(CarbonMessage cMsg) {
        ...
        if(pipe == null) {
            ...
            DefaultHttpContent responseBody = new DefaultHttpContent(Unpooled.wrappedBuffer(ByteBuffer.wrap(((String) cMsg.getSimplePayload()).getBytes(StandardCharsets.UTF_8))));
